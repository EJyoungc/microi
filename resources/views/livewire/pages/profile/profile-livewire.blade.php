                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    @if (Auth::user()->profile_picture == '') src="{{ asset('face-0.jpg') }}"  @else src="{{ asset('assets/uploads/' . Auth::user()->profile_picture) }}" @endif
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Vehicles</b> <a class="float-right">1,322</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Organisations</b> <a class="float-right">543</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Invites</b> <a class="float-right">13,287</a>
                                </li>
                            </ul>
