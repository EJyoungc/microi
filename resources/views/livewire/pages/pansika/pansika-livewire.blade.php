<div>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{asset('landing page/images/bg_3.jpg')}}');"
...
<x-modal title="{{$title}}" :status="$car_modal">
                ...
                <div class="col-md-4">
                    <div class="car-wrap rounded ftco-animate">
                        <div class="img rounded d-flex align-items-end"
                            style="background-image: url('{{asset('landing page/images/car-1.jpg')}}');">
                        </div>
                        <div class="text">
                            ...
                            <p class="d-flex mb-0 d-block"><a  class="btn btn-primary py-2 mr-1" wire:click.prevent='buy_car'>Buy
                                    now</a> <a href="#" class="btn btn-secondary py-2 ml-1">Hire</a>
                            </p>
                        </div>
                    </div>
                </div>
